...
class GetMenuAdditionByUserJob
{
    ...
    public function handle()
    {
        ...
        $menuAdditions = TablesModels\MenuAddition::join('menus', 'menu_additions.menu_id', '=', 'menus.id')
            ->select('menu_additions.*', 'menus.menu_name', 'menus.menu_no', 'menus.avater', 'menus.price as menu_price')
            ->whereIn('menu_additions.menu_id', $menuIds)->get();
